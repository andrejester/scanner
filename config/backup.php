...
return [
    ...
    'backup' => [
        ...
        'destination' => [
             ...
             */
            'filename_prefix' => 'DB-' . env('APP_NAME') . '-',
            ...
            // 'disks' => [
            //     'backup' => [
            //         'driver' => 'local', // Bisa diganti ke 's3', 'ftp', dll.
            //         'root' =>
            //         storage_path('app/public/' . env('APP_NAME')),
            //     ],
            // ],
        ],
         ...
         */
        'temporary_directory' => storage_path('app/public/' . env('APP_NAME')),
