...
use Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPBasicCancelException;
use Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPChannelClosedException;
use Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPConnectionBlockedException;
...
use Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPProtocolChannelException;
...
class AMQPChannel extends AbstractChannel
{
     ...
     * @throws \Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPTimeoutException if the specified operation timeout was exceeded
     * @return mixed
     */
     ...
     * @param string $routing_key
     * @param bool $nowait
     * @param \Classes\RabbitMQ\PhpAmqpLib\Wire\AMQPTable|array $arguments
     * @param int|null $ticket
     * @throws \Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPTimeoutException if the specified operation timeout was exceeded
     * @return mixed|null
     */
    ...
    /**
     * @param AMQPReader $reader
     * @throws \Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPBasicCancelException
     */
