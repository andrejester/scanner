...
namespace Classes\RabbitMQ\PhpAmqpLib\Connection;

use Classes\RabbitMQ\PhpAmqpLib\Channel\AbstractChannel;
use Classes\RabbitMQ\PhpAmqpLib\Channel\AMQPChannel;
use Classes\RabbitMQ\PhpAmqpLib\Channel\Frame;
use Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPConnectionClosedException;
use Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPHeartbeatMissedException;
use Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPInvalidFrameException;
use Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPIOException;
use Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPNoDataException;
use Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPRuntimeException;
use Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPSocketException;
use Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPTimeoutException;
use Classes\RabbitMQ\PhpAmqpLib\Helper\Assert;
//use Classes\RabbitMQ\PhpAmqpLib\Package;
use Classes\RabbitMQ\PhpAmqpLib\Wire;
use Classes\RabbitMQ\PhpAmqpLib\Wire\AMQPReader;
use Classes\RabbitMQ\PhpAmqpLib\Wire\AMQPTable;
use Classes\RabbitMQ\PhpAmqpLib\Wire\AMQPWriter;
use Classes\RabbitMQ\PhpAmqpLib\Wire\IO\AbstractIO;
...
abstract class AbstractConnection extends AbstractChannel
{
    ...
    public static $LIBRARY_PROPERTIES = array(
        'product' => array('S', 'AMQPLib') ,//Package::NAME),
        'platform' => array('S', 'PHP'),
        'version' => array('S', '3.7.1') ,//Package::VERSION),
        'information' => array('S', ''),
        'copyright' => array('S', ''),
        'capabilities' => array(
            'F',
     ...
     * @param \Classes\RabbitMQ\PhpAmqpLib\Connection\AMQPConnectionConfig | null $config
     * @throws \Exception
     */
     ...
     * @return AMQPChannel
     * @throws \Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPOutOfBoundsException
