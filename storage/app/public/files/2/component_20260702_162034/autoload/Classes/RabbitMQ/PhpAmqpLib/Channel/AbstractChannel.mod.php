...
namespace Classes\RabbitMQ\PhpAmqpLib\Channel;

use Classes\RabbitMQ\PhpAmqpLib\Connection\AbstractConnection;
use Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPChannelClosedException;
use Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPConnectionClosedException;
use Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPInvalidFrameException;
use Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPNoDataException;
use Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPNotImplementedException;
use Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPOutOfBoundsException;
use Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPOutOfRangeException;
use Classes\RabbitMQ\PhpAmqpLib\Helper\DebugHelper;
use Classes\RabbitMQ\PhpAmqpLib\Helper\Protocol\MethodMap080;
use Classes\RabbitMQ\PhpAmqpLib\Helper\Protocol\MethodMap091;
use Classes\RabbitMQ\PhpAmqpLib\Helper\Protocol\Protocol080;
use Classes\RabbitMQ\PhpAmqpLib\Helper\Protocol\Protocol091;
use Classes\RabbitMQ\PhpAmqpLib\Helper\Protocol\Wait080;
use Classes\RabbitMQ\PhpAmqpLib\Helper\Protocol\Wait091;
use Classes\RabbitMQ\PhpAmqpLib\Message\AMQPMessage;
use Classes\RabbitMQ\PhpAmqpLib\Wire;
use Classes\RabbitMQ\PhpAmqpLib\Wire\AMQPReader;
...
abstract class AbstractChannel
{
    ...
    /** @var \Classes\RabbitMQ\PhpAmqpLib\Helper\DebugHelper */
    protected $debug;
     ...
     * @throws \Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPRuntimeException
     */
     ...
     * @param \Classes\RabbitMQ\PhpAmqpLib\Wire\AMQPWriter|string $args
     */
     ...
     * @param array $method_sig
     * @param \Classes\RabbitMQ\PhpAmqpLib\Wire\AMQPWriter|string $args
     * @param \Classes\RabbitMQ\PhpAmqpLib\Wire\AMQPWriter $pkt
     * @return \Classes\RabbitMQ\PhpAmqpLib\Wire\AMQPWriter
     */
     ...
     * @return mixed
     * @throws \Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPRuntimeException
     * @throws \Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPTimeoutException
     * @throws \Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPConnectionClosedException
    ...
    /**
     * @param Frame $frame
     * @throws \Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPInvalidFrameException
     */
