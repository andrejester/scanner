...
use Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPInvalidArgumentException;
use Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPOutOfBoundsException;
use Classes\RabbitMQ\PhpAmqpLib\Helper\BigInteger;
...
abstract class AMQPReader extends AMQPByteStream
{
     ...
     * @return mixed
     * @throws \Classes\RabbitMQ\PhpAmqpLib\Exception\AMQPDataReadException
     */
