  ...
  <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme" id="layout-navbar">
      ...
      <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
        ...
        <ul class="navbar-nav align-items-center ms-auto flex-row">
          ...
          <!-- Quick links  -->
          <li class="nav-item dropdown-shortcuts navbar-dropdown dropdown me-xl-0 me-2">
              ...
              <div class="dropdown-shortcuts-list scrollable-container">
                ...
                <div class="row row-bordered g-0 overflow-visible">
                  <div class="dropdown-shortcuts-item col">
                    ...
                    <a href="{{ env('APP_URL') }}" class="stretched-link">Dashboard</a>
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                    <div class="d-flex">
                      <div class="me-3 flex-shrink-0">
                        <div class="avatar">
                          <img src="../../assets/img/avatars/2.png" alt class="w-px-40 rounded-circle h-auto">
                        </div>
                      </div>
                      <div class="flex-grow-1">
                  ...
                  <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                    <div class="d-flex">
                      <div class="me-3 flex-shrink-0">
                        <div class="avatar">
                          <img src="../../assets/img/avatars/9.png" alt class="w-px-40 rounded-circle h-auto">
                        </div>
                      </div>
                      <div class="flex-grow-1">
                  ...
                  <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                    <div class="d-flex">
                      <div class="me-3 flex-shrink-0">
                        <div class="avatar">
                          <img src="../../assets/img/avatars/5.png" alt class="w-px-40 rounded-circle h-auto">
                        </div>
                      </div>
                      <div class="flex-grow-1">
                  ...
                  <li class="list-group-item list-group-item-action dropdown-notifications-item">
                    <div class="d-flex">
                      <div class="me-3 flex-shrink-0">
                        <div class="avatar">
                          <img src="../../assets/img/avatars/6.png" alt class="w-px-40 rounded-circle h-auto">
                        </div>
                      </div>
                      <div class="flex-grow-1">
