<div class="card-datatable text-nowrap">
    ...
    @section('content')
        <h4 class="mb-4 py-3">
            <span class="text-muted fw-light">Home /</span> Data Masater Pelatihan
        </h4>

        @include('utils.modal')
        <!-- Ajax Sourced Server-side -->

        @can('masterpelatihan_write')
            <a class="btn btn-primary btn-sm mb-1" href="{{ route('masterpelatihan.create') }}"><i
