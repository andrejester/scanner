...
@section('content')
    <h4 class="mb-4 py-3">
        <span class="text-muted fw-light">Logo Perusahaan /</span> Tambah
    </h4>
    @if ($errors->any())
    ...
    @endif
    <div class="card mb-4">
        <form id="form1" class="card-body" action="{{ route('logoPerusahaan.store') }}" method="post">
            @csrf
            <div class="row g-3">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <label class="form-label" for="companydescription_address">Deskripsi 1</label>
