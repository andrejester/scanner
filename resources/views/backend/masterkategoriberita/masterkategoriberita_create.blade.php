...
@section('content')
    <h4 class="mb-4 py-3">
        <span class="text-muted fw-light">Kategori Berita /</span> Tambah
    </h4>
    @if ($errors->any())
    ...
    @endif
    <div class="card mb-4">
        <form id="form1" class="card-body" action="{{ route('masterkategoriberita.store') }}" method="post">
            @csrf
            <div class="row g-3">
                <div class="col-md-12">
                    ...
                    <div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="is_active" id="active" checked
                                value="active" wire:model="is_active">
                            <label class="form-check-label" for="active">Active</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="is_active" id="inactive" value="inactive"
