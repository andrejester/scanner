...
@section('content')
    ...
    <h4 class="mb-4 py-3">
        <span class="text-muted fw-light">Event /</span> Tambah
    </h4>
    ...
    <div class="card mb-4">
        <form id="form1" class="card-body" action="{{ route('masterevent.store') }}" method="POST"
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" id="kategori" class="form-control" name="kategori" value="{{ old('kategori') }}"
                        placeholder="Seminar, Workshop, Wisuda, dll">
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <textarea class="form-control" id="konten" name="konten" rows="10">{{ old('konten') }}</textarea>
                </div>
