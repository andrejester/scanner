...
<head>
    ...
    <style>
        .login-actions-container {
            ...
            /* Tombol akan ditempatkan berjauhan */
            gap: 10px;
...
<body>
    ...
    <div class="login-container">
        ...
        <form method="POST" class="form login" action="{{ route('2fa.verify') }}">
            @csrf
            <div class="form__field form__field--password">
                <label class="label label--icon" for="login__password">
                    ...
                    <span class="hidden">Sandi 2FA</span>
                </label>
                <div class="form__input-wrapper">
                    <input id="login__password" type="password" name="google2fa_token" class="form__input"
                        placeholder="Masukan Sandi 2FA" required />
                    <div class="underline-wrapper">
                        <span class="underline"></span>
                        @error('google2fa_token')
                            <span class="text-danger" style="color: #ff0000">{{ $message }}</span>
                        @enderror
                    </div>
                </div>
            </div>
            ...
            <div class="login-actions-container">
                <div class="form__field form__field--submit">
                    <!-- Styling tombol untuk lebih jelas -->
                    <button type="submit" class="btn btn--primary">Verifikasi</button>
                    <a href="{{ route('log-adm') }}" class="btn btn--secondary">Login</a>
                </div>
            </div>
        </form>
